...
If MapData(UserList(UserIndex).POS.Map, UserList(UserIndex).POS.X, UserList(UserIndex).POS.Y).UserIndex Then
    ...
    Call SendData(ToIndex, TIndex, 0, "!!Un personaje se ha conectado en tu misma posición, has sido movido 1 lugar.")
...
Call SendData(ToIndex, UserIndex, 0, "||Bienvenido a Mysteriun AO vBeta" & FONTTYPE_INTRO)
Call SendData(ToIndex, UserIndex, 0, "||Recuerda leer nuestro reglamento oficial, en nuestra web oficial" & FONTTYPE_INTRO)
Call SendData(ToIndex, UserIndex, 0, "||http://www.mysteriun-ao.ucoz.com" & FONTTYPE_INTRO)
...
If UCase$(Left$(rdata, 8)) = "/CANJEO " Then
    ...
    End If
    If rdata = "T17" Then
        If UserList(UserIndex).Faccion.Quests >= 40 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 839 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido un Item. Se te ha descontado de tus Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).Faccion.Quests = UserList(UserIndex).Faccion.Quests - 40
        End If
    End If
    If rdata = "T18" Then
        If UserList(UserIndex).Faccion.Quests >= 40 Then
    ...
    'Espada Fantasmal
        ...
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido un Item. Se te ha descontado de tus Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).Faccion.Quests = UserList(UserIndex).Faccion.Quests - 2
        End If
    End If
        If rdata = "T35" Then
        If UserList(UserIndex).Faccion.Quests >= 30 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 1004 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido un Item. Se te ha descontado de tus Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).Faccion.Quests = UserList(UserIndex).Faccion.Quests - 30
        End If
    End If
        ...
        If UserList(UserIndex).Faccion.Quests >= 30 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 1005 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido un Item. Se te ha descontado de tus Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).Faccion.Quests = UserList(UserIndex).Faccion.Quests - 30
        End If
    End If
        ...
        If UserList(UserIndex).Faccion.Quests >= 30 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 1006 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido un Item. Se te ha descontado de tus Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).Faccion.Quests = UserList(UserIndex).Faccion.Quests - 30
        End If
...
If UCase$(Left$(rdata, 10)) = "/CONCILIO " Then
   rdata = Right$(rdata, Len(rdata) - 10)
                If UserList(UserIndex).flags.EsConseCaos Or UserList(UserIndex).flags.Privilegios = 3 Or UserList(UserIndex).flags.Privilegios = 2 Then
                    Call SendData(ToCaos, 0, 0, "||[" & UserList(UserIndex).Name & "]-Consejo del Caos> " & rdata & FONTTYPE_CONSEJOCAOS)
                   Call SendData(ToAdmins, 0, 0, "||[" & UserList(UserIndex).Name & "]-Consejo del Caos> " & rdata & FONTTYPE_CONSEJOCAOS)
                End If
        Exit Sub
        End If
...
If UCase$(rdata) = "/SALA1" Then
    If UserList(UserIndex).POS.Map <> 1 Then
        Call SendData(ToIndex, UserIndex, 0, "||Debes estar en la Ciudad Ullathorpe para Jugar" & FONTTYPE_INFO)
        Exit Sub
    End If
    If UserList(UserIndex).flags.DueLeanDo = True Then
    ...
    If MapInfo(192).NumUsers = 0 Then
        ...
        Call WarpUserChar(UserIndex, 192, 18, 75, True)
    ...
    Else
        If MapInfo(192).NumUsers = 1 Then
            Call WarpUserChar(UserIndex, 192, 29, 85, True)
...
If UCase$(rdata) = "/SALA2" Then
    ...
    If MapInfo(193).NumUsers = 0 Then
        ...
        Call WarpUserChar(UserIndex, 193, 18, 75, True)
        Call SendData(ToIndex, UserIndex, 0, "||Has sido llevado a la sala de Duelos! cuando quieras salir, teclea: /SALIRDUELO" & FONTTYPE_INFO)
        UserList(UserIndex).flags.DueLeanDo = True
        Exit Sub
    Else
        If MapInfo(193).NumUsers = 1 Then
            Call WarpUserChar(UserIndex, 193, 29, 85, True)
            Call SendData(ToIndex, UserIndex, 0, "||Has sido llevado a la sala de Duelos! cuando quieras salir, teclea: /ABANDONARSALA" & FONTTYPE_INFO)
            UserList(UserIndex).flags.DueLeanDo = True
...
If UCase$(rdata) = "/SALA3" Then
    ...
    If MapInfo(194).NumUsers = 0 Then
        ...
        Call WarpUserChar(UserIndex, 194, 18, 75, True)
        Call SendData(ToIndex, UserIndex, 0, "||Has sido llevado a la sala de Duelos! cuando quieras salir, teclea: /SALIRDUELO" & FONTTYPE_INFO)
        UserList(UserIndex).flags.DueLeanDo = True
        Exit Sub
    Else
        If MapInfo(194).NumUsers = 1 Then
            Call WarpUserChar(UserIndex, 194, 29, 85, True)
            Call SendData(ToIndex, UserIndex, 0, "||Has sido llevado a la sala de Duelos! cuando quieras salir, teclea: /ABANDONARSALA" & FONTTYPE_INFO)
            UserList(UserIndex).flags.DueLeanDo = True
...
If UCase$(rdata) = "/SALA4" Then
    ...
    If MapInfo(195).NumUsers = 0 Then
        ...
        Call WarpUserChar(UserIndex, 195, 18, 75, True)
        Call SendData(ToIndex, UserIndex, 0, "||Has sido llevado a la sala de Duelos! cuando quieras salir, teclea: /SALIRDUELO" & FONTTYPE_INFO)
        UserList(UserIndex).flags.DueLeanDo = True
        Exit Sub
    Else
        If MapInfo(195).NumUsers = 1 Then
            Call WarpUserChar(UserIndex, 195, 29, 85, True)
            Call SendData(ToIndex, UserIndex, 0, "||Has sido llevado a la sala de Duelos! cuando quieras salir, teclea: /ABANDONARSALA" & FONTTYPE_INFO)
            UserList(UserIndex).flags.DueLeanDo = True
...
If UCase$(Left$(rdata, 8)) = "/CONMSJ " Then
    ...
    If UserList(UserIndex).flags.EsConseCaos = True Then
        Call SendData(ToAll, UserIndex, 0, "||Concilio de MysteriunAO > " & rdata & FONTTYPE_CONSEJOCAOS)
        Exit Sub
    End If
    If UserList(UserIndex).flags.EsConseReal = True Then
        Call SendData(ToAll, UserIndex, 0, "||Concejo de MysteriunAO > " & rdata & FONTTYPE_CONSEJO)
        Exit Sub
    End If
    Exit Sub
End If
...
If UCase$(Left$(rdata, 8)) = "/TORNEO " Then
    ...
    If entorneo = 0 Then
        ...
        Call SendData(ToIndex, UserIndex, 0, "||Has activado el torneo" & FONTTYPE_FENIX)
        Call SendData(ToAll, 0, 0, "||Torneo para " & PTorneo & " jugadores! /PARTICIPAR para entrar." & FONTTYPE_FENIX)
    Else
        entorneo = 0
        Call SendData(ToIndex, UserIndex, 0, "||Has desactivado el torneo" & FONTTYPE_FENIX)
    End If
    Exit Sub
End If
...
TIndex = NameIndex(rdata)
 If TIndex <= 0 Then
        Call SendData(ToIndex, UserIndex, 0, "|| No está online el usuario indicado " & FONTTYPE_FENIX)
        Exit Sub
    End If
  Dim Bronce As Obj
 
Bronce.Amount = 1  'Cantidad de copas
     Bronce.OBJIndex = 826  'Numero de item
     
    Call MeterItemEnInventario(TIndex, Bronce) 'Metemos Item En Inventario.
     
      Call SendData(ToAll, 0, 0, "||El usuario " & TIndex & " recibió una copa de bronce por haber salido tercero en el evento realizado" & FONTTYPE_BRONCE)
...
Plata.Amount = 1  'Cantidad de copas
     Plata.OBJIndex = 825  'Numero de item
     
    Call MeterItemEnInventario(TIndex, Plata) 'Metemos Item En Inventario.
     
      Call SendData(ToAll, 0, 0, "||El usuario " & TIndex & " recibió una copa de plata por haber salido segundo en el evento realizado" & FONTTYPE_PLATA)
...
Oro.Amount = 1  'Cantidad de copas
     Oro.OBJIndex = 824  'Numero de item
     
    Call MeterItemEnInventario(TIndex, Oro) 'Metemos Item En Inventario.
     
      Call SendData(ToAll, 0, 0, "||El usuario " & TIndex & " recibió una copa de oro por haber salido primero en el evento realizado" & FONTTYPE_ORO)
