    ...
    Select Case Modo
        ...
        Case 1, 4, 5
            ...
            ElseIf UserList(UserIndex).flags.Privilegios Then
                Color = &HC000&
                ElseIf UserList(UserIndex).flags.EsConseReal And UserList(UserIndex).Faccion.Bando = Real Then 'Consejo
                Color = &HFFFF80
ElseIf UserList(UserIndex).flags.EsConseCaos And UserList(UserIndex).Faccion.Bando = Caos Then 'Concilio
                Color = &HC0C0FF
