...
Call SendData(ToAll, 0, 0, "||¿Te gusta el servidor? Si te gusta recomendados con tus amigos, para que nos divirtamos mucho mas todos juntos." & FONTTYPE_FENIX)
Call SendData(ToAll, 0, 0, "||http://mysteriun-ao.ucoz.com" & FONTTYPE_INTRO1)
A = 0
End If
End Sub
...
Call SendData(ToAll, 0, 0, "||¿Tenes ganas de consultar algo y no hay Game Masters online? Contáctanos mediante nuestro MSN oficial" & FONTTYPE_FENIX)
Call SendData(ToAll, 0, 0, "||mysteriun-ao@hotmail.com" & FONTTYPE_INTRO1)
A = 0
End If
End Sub
...
Call SendData(ToAll, 0, 0, "||No te olvides de leer el reglamento oficial, que se encuentra en la pagina oficial o en el foro oficial de MAO." & FONTTYPE_FENIX)
Call SendData(ToAll, 0, 0, "||http://mysteriun-ao.ucoz.com || http://mysteriun-ao.foroac.net" & FONTTYPE_INTRO1)
A = 0
End If
End Sub
