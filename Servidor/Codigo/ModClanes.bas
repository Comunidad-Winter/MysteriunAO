...
Call SendData(ToIndex, UserIndex, 0, "||No puedes fundar clan en este mapa, por favor, dirigete al mapa 1." & FONTTYPE_INFO)
Exit Function
 End If
...
Call SendData(ToIndex, UserIndex, 0, "||Para fundar un clan en las tierras de MysteriunAO, tienes que ser Pirata." & FONTTYPE_INFO)
Exit Function
End If
