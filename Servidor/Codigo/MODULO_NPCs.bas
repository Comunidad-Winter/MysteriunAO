...
Sub NombreNpc(NpcIndex As Integer, UserIndex As Integer)
Dim npcNombre As String
npcNombre = Npclist(NpcIndex).Name
Call SendData(ToIndex, UserIndex, 0, "NPC" & npcNombre)
End Sub
