...
If UserList(LadronIndex).POS.Map = 190 Or UserList(LadronIndex).POS.Map = 202 Or UserList(LadronIndex).POS.Map = 204 Or UserList(LadronIndex).POS.Map = 203 Or UserList(LadronIndex).POS.Map = 191 Then
    Exit Sub
End If
