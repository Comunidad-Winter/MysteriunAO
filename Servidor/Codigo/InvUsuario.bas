...
If UserList(UserIndex).POS.Map = 34 Then Exit Sub
If UserList(UserIndex).POS.Map = 59 Then Exit Sub
If UserList(UserIndex).POS.Map = 98 Then Exit Sub
If UserList(UserIndex).POS.Map = 62 Then Exit Sub
If UserList(UserIndex).POS.Map = 170 Then Exit Sub
...
If UserList(UserIndex).POS.Map = 201 Then Exit Sub
